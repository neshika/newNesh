...
#zatemnenie {
	...
	Электронный адрес*: <input type="email" name="email" ><br>
        ...
        <p>Питомник / Заводская приставка*: <input type="test" name="kennel"  maxlength="15"><br><br>
        ...
        <p><h4>Контакты:</h4>
	Телефон в формате +79161112244: <input type="tel" name="tel" maxlength="12" pattern="+7([0-9]{3})[0-9]{3}\-[0-9]{2}\-[0-9]{2}"value="+7"><br>
                ФИО: <input type="test" name="fio" value="" maxlength="100" ><br>
	Дата: <input type="test" name="datel" value=<?php echo date('d.m.Y', time() - 86400);?>><br>
	</p><hr>
